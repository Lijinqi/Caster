...
public class TipLayout extends FrameLayout {
    // 图标
    private CircleImageView mTipView;
    // windowManager
    ...
    public TipLayout(@NonNull Context context) {
        ...
        mTipView = findViewById(R.id.civ_tip);
        mViewWidth = mTipView.getLayoutParams().width;
        mViewHeight = mTipView.getLayoutParams().height;
    }
