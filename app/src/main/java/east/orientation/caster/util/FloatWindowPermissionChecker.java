...
public class FloatWindowPermissionChecker {
    ...
    public static boolean checkFloatWindowPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            return Settings.canDrawOverlays(CastApplication.getAppContext());
    ...
    private static boolean checkOps() {
        try {
            Object object = CastApplication.getAppContext().getSystemService(Context.APP_OPS_SERVICE);
            if (object == null) {
                return false;
            }
            ...
            arrayOfObject1[2] = CastApplication.getAppContext().getPackageName();
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton("是", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        tryJumpToPermissionPage(context);
                        dialog.dismiss();
                    }
                })
